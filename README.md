...
The bundled `stty` is a static, minimal Asuswrt-Merlin compatibility helper used only by the RNGD hardware RNG path to configure the selected serial HWRNG device before `rngd` starts.
